...
class UploadedBook(SqlAlchemyBase, BaseMixins):
    ...
    translation_page_start: FilterableColumn[int | None] = mapped_column(Integer, nullable=True)
    translation_page_end: FilterableColumn[int | None] = mapped_column(Integer, nullable=True)
    ...
    extraction_page_start: FilterableColumn[int | None] = mapped_column(Integer, nullable=True)
    extraction_page_end: FilterableColumn[int | None] = mapped_column(Integer, nullable=True)
