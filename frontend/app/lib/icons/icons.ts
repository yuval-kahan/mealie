...
export const icons = {
  ...
  pin: mdiPin,
  notebook: mdiNotebookOutline,
  notebookPlus: mdiNotebookPlusOutline,
  ...
  formatIndentDecrease: mdiFormatIndentDecrease,
  formatIndentIncrease: mdiFormatIndentIncrease,
  formatSubscript: mdiFormatSubscript,
